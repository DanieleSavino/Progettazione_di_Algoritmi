...
"""
    Dato un grafo come matrice binaria di adiacenza `M` vogliamo sapere se esiste un pozzo universale nel grafo.<br>
    Ossia un nodo che non abbia nessun arco uscente (Pozzo), e che sia raggiungibile da tutti gli altri nodi (Universale).<br><br>
