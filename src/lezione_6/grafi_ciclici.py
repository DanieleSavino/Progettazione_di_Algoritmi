...
"""
    Dato un grafo vogliamo sapere se ha un ciclo, per il `grafo indiretto` basta trovare una collisione nella `DFS`, che non sia con il padre,
    per il `grafo diretto`, invece, bisogna avere una collisione con un nodo attivo,
    poichè nell'algoritmo per il grafo indiretto un pozzo verrebbe considerato come un ciclo
"""

## Controllo sottografo indiretto
